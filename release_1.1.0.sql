...
--changeset Mike:CREATE_PROCEDURE_[dbo].[CustOrderHist1] context:DEV labels:Jira1000
...
--changeset Mike:CREATE_PROCEDURE_[dbo].[CustOrderHist2] context=DEV labels=Jira1001
...
--changeset Kevin:ALTER_PROCEDURE_[dbo].[CustOrderHist2] context:QA labels:Jira1000,Jira1009 runOnChange:true
...
--changeset SteveZ:insertInto_salesTableZ context:DEV labels:Jira1012,Jira1034
